...
describe("ProductDetail modal", () => {
  beforeEach(() => {
    ...
    // jsdom does not implement the native HTMLDialogElement modal APIs.
    // ProductDetail uses showModal()/close(), so provide lightweight
    ...
    // AuthProvider reads the logged-in user from localStorage on init.
