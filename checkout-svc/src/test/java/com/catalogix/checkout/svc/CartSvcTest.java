...
import com.catalogix.checkout.model.Cart;
import com.catalogix.checkout.model.CartItem;
import com.catalogix.checkout.model.Coupon;
import com.catalogix.checkout.model.DiscountType;
import com.catalogix.checkout.repository.CartRepository;
...
class CartSvcTest {
    ...
    void cartShowsUnavailableItemGracefullyWhenProductLookupFails() {
        ...
        when(productSvcClient.fetchProduct(1L, TOKEN))
                .thenThrow(new com.catalogix.checkout.exception.ProductUnavailableException("Product not found: 1"));
