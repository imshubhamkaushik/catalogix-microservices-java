...
// {"error": ...} this used to return — the frontend's Coupons admin page
// reads err.response.data.message, so the old shape silently swallowed
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInvalid(CouponInvalidException ex) {
        Map<String, Object> body = new HashMap<>();
